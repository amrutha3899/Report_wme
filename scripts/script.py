...
def main():
    ...
    #logging.basicConfig(filename='logs/script.log', level=logging.DEBUG, format='%(asctime)s - %(levelname)s: %(message)s', datefmt='%Y-%m-%d %H:%M:%S')
    ...
    try:
        ...
        if database in existing_databases:
            ...
            delete_query = f'DROP DATABASE {database};'
        ...
        for file_name in os.listdir(folder_path):
            ...
            if file_name.endswith(('.xls', '.xlsx')):
                ...
                try:
                    ...
                    sheet_name = 'Cable'  # default sheet name
        ...
        # Log any exceptions
        logging.error(f'Error in script.py: {str(e)} {current_time}')
